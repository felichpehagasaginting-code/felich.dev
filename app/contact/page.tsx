...
export default function Contact() {
  ...
  return (
    <div>
      ...
      {/* Social media label */}
      <p className="text-sm text-[var(--text-muted)] mb-6">Find me on social media</p>
      ...
      >
        ...
        <div className="relative rounded-2xl border border-[var(--border-default)] bg-[var(--glass-bg)] backdrop-blur-[50px] overflow-hidden shadow-2xl">
          ...
          <div className="flex flex-col md:flex-row min-h-[400px]">
            ...
            <div className="w-full md:w-[320px] p-8 md:p-10 border-r border-[var(--border-default)] bg-[var(--bg-base)] relative z-10 flex flex-col items-center md:items-start">
              <div className="relative mb-6">
                <div className="absolute -inset-1 bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] rounded-full blur-[2px]" />
                <div className="relative w-24 h-24 rounded-full bg-[var(--bg-base)] p-1">
                ...
                <div className="absolute -bottom-1 -right-1 w-7 h-7 bg-[#0095f6] rounded-full border-4 border-[var(--bg-base)] flex items-center justify-center text-white">
              ...
              <div className="text-center md:text-left w-full">
                <h3 className="text-xl font-bold text-[var(--text-primary)] mb-1">fel.comp</h3>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-[var(--bg-muted)]">
                    <span className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Posts</span>
                    <span className="text-sm font-black text-[var(--text-primary)]">12</span>
                  </div>
                  <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-[var(--bg-muted)]">
                    <span className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Followers</span>
                    <span className="text-sm font-black text-[var(--text-primary)]">516</span>
                  </div>
                  <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-[var(--bg-muted)]">
                    <span className="text-[10px] font-bold text-[var(--text-muted)] uppercase tracking-wider">Following</span>
                    <span className="text-sm font-black text-[var(--text-primary)]">488</span>
                  </div>
                </div>
            ...
            <div className="flex-1 p-6 md:p-8 bg-[var(--bg-base)]">
          ...
          <div className="h-8 flex items-center justify-between px-4 bg-[var(--bg-base)] border-t border-[var(--border-default)]">
            <div className="flex gap-4">
              <span className="text-[9px] font-medium text-[var(--text-muted)]">12 Items</span>
              <span className="text-[9px] font-medium text-[var(--text-muted)]">2.4 GB available</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-2 h-2 rounded-full bg-[var(--success)] animate-pulse" />
              <span className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-widest">Live Sync</span>
            </div>
          </div>
        </div>
      </motion.div>
      ...
      >
        <p className="text-sm text-[var(--text-muted)] mb-6">Or send me a message</p>
