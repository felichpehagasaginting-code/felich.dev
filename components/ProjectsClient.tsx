              ...
              <div className="p-6 md:p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                  <div className="md:col-span-2 space-y-8">
                    <div className="prose dark:prose-invert prose-p:text-neutral-600 dark:prose-p:text-neutral-300">
                        {/* We could render MDX content here, but keeping it simple for now! */}
                        <p>{selectedProject.description}</p>
                        <p>This project was built leveraging modern web standards and responsive design practices.</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6 bg-neutral-50 dark:bg-neutral-800/50 p-6 rounded-2xl h-fit">
                    ...
                    {selectedProject.github && (
                      <a href={selectedProject.github} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-white dark:bg-neutral-900 rounded-xl hover:shadow-md transition-shadow group">
                    ...
                    {selectedProject.live && selectedProject.live !== "" && (
                      <a href={selectedProject.live} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3 bg-primary text-white rounded-xl shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:shadow-[0_0_20px_rgba(59,130,246,0.5)] transition-shadow">
