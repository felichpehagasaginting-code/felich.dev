      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            <div 
              className={`absolute -top-[20%] -left-[10%] w-[60%] h-[60%] rounded-full blur-[80px] md:blur-[120px] opacity-30 md:opacity-40 bg-gradient-to-br from-blue-600/30 to-purple-600/30 ${isMobile ? '' : 'animate-blob-1'}`}
            />
            {!isMobile && (
              <div 
                className="absolute top-[30%] -right-[10%] w-[50%] h-[50%] rounded-full blur-[140px] opacity-30 bg-gradient-to-br from-pink-500/20 to-orange-500/20 animate-blob-2"
              />
            )}
            <div 
              className={`absolute -bottom-[10%] left-[20%] w-[45%] h-[45%] rounded-full blur-[70px] md:blur-[110px] opacity-20 md:opacity-25 bg-gradient-to-br from-emerald-500/20 to-cyan-500/20 ${isMobile ? '' : 'animate-blob-3'}`}
            />
          </div>
          ...
          {theme === 'apple' && (
            <div className="absolute inset-0 pointer-events-none z-50">
              ...
              {!isMobile && (
                <div 
                  className="absolute inset-0 border-[20px] border-transparent bg-gradient-to-tr from-blue-500/5 via-purple-500/5 to-pink-500/5 blur-[40px] opacity-30 animate-apple-glow"
                />
              )}
            </div>
          )}
          ...
          {timeStyle === 'night' && (
            <>
              ...
              <div 
                className="absolute inset-0 opacity-10 dark:opacity-20 mix-blend-screen bg-star-pattern" 
              />
            </>
          )}
        </motion.div>
